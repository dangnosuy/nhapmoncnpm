...
-- Maps to existing users (36-55) and products (10-12)
-- ==========================================
...
-- Product ID mapping:
-- 10 = Không kỳ hạn, 11 = 3 tháng kỳ hạn, 12 = 6 tháng kỳ hạn
...
(36, 12, 50000000.00, '2025-03-15 11:00:00', 'ACTIVE');
...
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(38, 12, 100000000.00, '2025-02-05 10:00:00', 'ACTIVE'),
(38, 12, 30000000.00, '2025-03-01 11:00:00', 'ACTIVE'),
(38, 12, 50000000.00, '2025-04-01 08:00:00', 'ACTIVE');
...
(40, 12, 80000000.00, '2025-03-01 10:00:00', 'ACTIVE');
...
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(42, 12, 150000000.00, '2025-03-10 08:00:00', 'ACTIVE'),
(42, 12, 100000000.00, '2025-04-01 09:00:00', 'ACTIVE'),
...
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(44, 12, 25000000.00, '2025-03-25 13:00:00', 'ACTIVE'),
(44, 10, 10000000.00, '2025-04-10 09:00:00', 'ACTIVE');

-- User 45 (Lan) — 2 accounts
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(45, 12, 20000000.00, '2025-04-05 08:00:00', 'ACTIVE'),
(45, 12, 30000000.00, '2025-05-01 10:00:00', 'ACTIVE');

-- User 46 (Minh) — 3 accounts
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(46, 12, 200000000.00, '2025-04-15 09:00:00', 'ACTIVE'),
(46, 12, 100000000.00, '2025-05-01 10:00:00', 'ACTIVE'),
...
(48, 12, 50000000.00, '2025-05-15 10:00:00', 'ACTIVE');
...
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(50, 12, 80000000.00, '2025-05-10 10:00:00', 'ACTIVE'),
(50, 12, 40000000.00, '2025-06-01 11:00:00', 'ACTIVE');
...
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(52, 12, 100000000.00, '2025-05-20 11:00:00', 'ACTIVE'),
(52, 12, 30000000.00, '2025-06-01 08:00:00', 'ACTIVE');

-- User 53 (Uyên) — 1 account
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(53, 12, 25000000.00, '2025-05-25 13:00:00', 'ACTIVE');
...
INSERT INTO savings_accounts (user_id, product_id, principal_balance, opened_at, status) VALUES
(55, 12, 60000000.00, '2025-06-10 09:00:00', 'ACTIVE'),
...
(43, 12, 0.00, '2025-02-01 11:00:00', 'CLOSED'),
...
(36, @first_acct+2, 12, 50000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-03-15 11:00:00'),
...
(38, @first_acct+5, 12, 100000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-02-05 10:00:00'),
(38, @first_acct+6, 12, 30000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-03-01 11:00:00'),
(38, @first_acct+7, 12, 50000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-04-01 08:00:00'),
...
(40, @first_acct+10, 12, 80000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-03-01 10:00:00'),
...
(42, @first_acct+13, 12, 150000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-03-10 08:00:00'),
(42, @first_acct+14, 12, 100000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-04-01 09:00:00'),
...
(44, @first_acct+17, 12, 25000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-03-25 13:00:00'),
...
(45, @first_acct+20, 12, 30000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-05-01 10:00:00'),
(46, @first_acct+21, 12, 200000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-04-15 09:00:00'),
(46, @first_acct+22, 12, 100000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-05-01 10:00:00'),
...
(48, @first_acct+26, 12, 50000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-05-15 10:00:00'),
(49, @first_acct+27, 11, 15000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-05-05 08:30:00'),
(50, @first_acct+28, 12, 80000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-05-10 10:00:00'),
(50, @first_acct+29, 12, 40000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-06-01 11:00:00'),
(51, @first_acct+30, 10, 8000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-05-15 09:30:00'),
(52, @first_acct+31, 12, 100000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-05-20 11:00:00'),
(52, @first_acct+32, 12, 30000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-06-01 08:00:00'),
(53, @first_acct+33, 12, 25000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-05-25 13:00:00'),
(54, @first_acct+34, 12, 20000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-06-05 08:00:00'),
(55, @first_acct+35, 12, 60000000.00, 'OPEN_SAVINGS', 'APPROVED', 0, 2, '2025-06-10 09:00:00'),
...
(38, @first_acct+5, 12, 20000000.00, 'DEPOSIT_TO_SAVINGS', 'APPROVED', 0, 2, '2025-04-10 09:00:00'),
(40, @first_acct+9, 12, 10000000.00, 'DEPOSIT_TO_SAVINGS', 'APPROVED', 0, 2, '2025-04-20 11:00:00'),
(42, @first_acct+13, 12, 30000000.00, 'DEPOSIT_TO_SAVINGS', 'APPROVED', 0, 2, '2025-05-15 08:00:00'),
(45, @first_acct+19, 12, 5000000.00, 'DEPOSIT_TO_SAVINGS', 'APPROVED', 0, 2, '2025-06-01 09:00:00'),
(46, @first_acct+21, 12, 50000000.00, 'DEPOSIT_TO_SAVINGS', 'APPROVED', 0, 2, '2025-06-10 10:00:00'),
...
(43, @first_acct+39, 12, 20000000.00, 'CLOSE_SAVINGS', 'APPROVED', 600000.00, 2, '2025-05-10 11:00:00'),
...
(40, NULL, 12, 50000000.00, 'OPEN_SAVINGS', 'PENDING', 0, NULL, NOW() - INTERVAL 45 MINUTE),
...
INSERT INTO transactions (user_id, account_id, target_product_id, amount, transaction_type, status, interest_amount, processed_by, created_at) VALUES
(39, NULL, 12, 500000.00, 'OPEN_SAVINGS', 'REJECTED', 0, 2, '2025-03-01 10:00:00'),
